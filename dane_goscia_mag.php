...
<div class="row" style="padding:10px;border:10px;margin;margin-bottom:10px;">
				...
				<h2>Wprowadź swoje dane:</small></h2>
				</div>
</div>	
			
	<section class="cel_wizyty" style="padding-bottom:0px;">
		<div class="container">
			<form class="needs-validation" action="rejestracja_goscia_mag.php" novalidate>
				<input type="hidden" name="cel" value=<?php echo $cel ?> />
				<input type="hidden" name="cel2" value=<?php echo $cel2 ?> />
				  <div class="form-row justify-content-center">
					<div class="col-xl-3 mb-3 ">
					  <label for="validationCustom01"></label>
					  <input type="text" name="imie" class="form-control" id="validationCustom01" placeholder="Imię" autocomplete="off" required>
					...
					<div class="col-xl-3 mb-3">
					  ...
					  <input type="text" name="nazwisko" class="form-control" id="validationCustom02" placeholder="Nazwisko" autocomplete="off" required>
					  <div class="valid-feedback">
						Dane prawidłowe!
					  </div>
						<div class="invalid-feedback">
					...
					<div class="col-xl-3 mb-3">
					  <label for="validationCustom02"></label>
					  <input type="text" name="nazwa_firmy" class="form-control" id="validationCustom02" placeholder="Nazwa firmy" autocomplete="off" required>
					  <div class="valid-feedback">
						Dane prawidłowe!
					  </div>
						<div class="invalid-feedback">
					...
					<div class='form-check' style="padding-left:0px;"></br>
						<input class='form-check-input' type='checkbox' value='' id='invalidCheck' required>
							...
							Oświadczam, że zapoznałem/łam się z zasadami BHP.</a>
							</label>
							<div class='invalid-feedback'>
				  ...
				  <hr class='hr-text' style='border-color:#fff;'>
					   ...
					   $paragraphs = 0;
						if ($fh = fopen('zgoda'.$cel.$cel2.'.txt','r')) {
						  while (! feof($fh)) {
							$s = fgets($fh,1048576);
							if (("\n" == $s) || ("\r\n" == $s)) 
							{						
...
<footer class="page-footer absolute-bottom" style="background-color:#212529; padding-bottom:20px; display:block;">
		<div class="footer-copyright text-center pt-3" style=""><hr class="hr-text" style="border-color:#fff;">JS Developers &copy; 2022 <br /> Wszelkie prawa zastrzeżone</div>
</footer>
