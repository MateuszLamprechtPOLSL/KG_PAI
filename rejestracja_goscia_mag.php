...
else
{
	...
	if($cel==4 AND $cel2==2) 
	{
		...
		$sql2="INSERT INTO `tab_mag` SET imie= '$imie', nazwisko= '$nazwisko', nazwa_firmy= '$nazwa_firmy', cel2=2";
		$polaczenie->query($sql2);
	}
	if($cel==4 AND $cel2==1) $sql = "INSERT INTO `tab_mag` SET imie= '$imie', nazwisko= '$nazwisko', nazwa_firmy= '$nazwa_firmy', cel2='$cel2'";
