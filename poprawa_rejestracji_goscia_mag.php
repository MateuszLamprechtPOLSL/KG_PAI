...
{
	$sql2 = "
	SELECT * FROM tab_przyszli_mag
	LIMIT 1";
	$sql3 = "
	DELETE FROM tab_przyszli_mag
	LIMIT 1";	
	...
	if($cel==4 AND $cel2==2) 
	{
		$sql4 = "INSERT INTO `tab_st_prac_mag` SET imie= '$imie', nazwisko= '$nazwisko', nazwa_firmy= '$nazwa_firmy'";
	...
	if($cel==4 AND $cel2==1) $sql = "UPDATE tab_mag SET imie='".$imie."', nazwisko='".$nazwisko."', czas='".$data2."', nazwa_firmy='".$nazwa_firmy."' WHERE nazwisko='".$PPnazwisko."' AND obecny=1 AND imie='".$PPimie."'";
	  ...
	  <div class="panel-group" id="accordion" style="margin-left:10%; margin-right:10%; font-size:18px;">
		<div class="panel panel-default">
		  <div class="panel-heading">
			...
			<?php echo '<a href="drukuj_mag.php?nazwisko='.$nazwisko.'&imie='.$imie.'&data='.$data.'&nazwa_firmy='.$nazwa_firmy.'&cel='.$cel.'&cel2='.$cel2.'">Powrót do strony głównej</a>';?>
			</h3>
		  </div>
		</div>
